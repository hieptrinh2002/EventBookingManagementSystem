                    ...
                    <div class="card border-0">
                        <figure class="card-img-top m-0 overflow-hidden bsb-overlay-hover">
                            <a href="/events/{{ $event['id'] }}">
                                <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="https://images.pexels.com/photos/1190297/pexels-photo-1190297.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Son Tung MT-P">
                            </a>
                            <figcaption>
                        ...
                        <div class="card-body border bg-white p-4">
                            ...
                            <a href="/events/{{ $event['id'] }}" class="btn btn-primary m-0 text-nowrap entry-more">Buy ticket</a>
                        </div>
