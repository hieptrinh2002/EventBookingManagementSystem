                ...
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="dateOfBirth" type="date" class="form-control @error('dateOfBirth') is-invalid @enderror" name="dateOfBirth" value="{{ old('dateOfBirth', date('Y-m-d')) }}" required>
