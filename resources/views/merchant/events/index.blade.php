                        ...
                        <tbody>
                            @foreach ($events as $key => $event)
                                <tr class="py-2">
                                    ...
                                    <td class="align-middle text-center"> {{ $event['location'] }} </td>
                                    <td class="align-middle text-center"> {{ $event['status'] }} </td>
                                    <td class="align-middle text-center"> {{ $event['maxQuantity'] }} </td>
